...
EDTAPI void   check_hw_fw_conflicts(EdtDev *edt_p, EdtBitfile *bitfile);
EDTAPI int    get_bitfile_rev(EdtBitfile *bitfile);

EDTAPI int    check_id_stuff(char *bid, char *pid, int devid, int verify_only, char *fname, int sector);
...
EDTAPI int edt_check_ask_info(EdtDev *edt_p, int promcode, int sect, EdtPromData *pdata,
                              int verify_or_check_only, int proginfo, int nofs);
...
EDTAPI char *edt_merge_esns(char *new_esn, char *esn, char *new_sn, char *new_opts, char *new_pn,
                            char *new_rev, char *new_clock);
...
typedef int (*EdtPciLoadVerify)(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata,
                                int promcode, int segment, int vfonly, int warn, int verbose);
...
int program_verify_XC2S300E(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata, int promcode,
                            int segment, int vfonly, int warn, int verbose);
int program_verify_XC2S200(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata, int promcode,
                           int segment, int vfonly, int warn, int verbose);
int program_verify_XC2S150(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata, int promcode,
                           int segment, int vfonly, int warn, int verbose);
int program_verify_4028XLA(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata, int promcode,
                           int segment, int vfonly, int warn, int verbose);
int program_verify_default(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata, int promcode,
                           int segment, int vfonly, int warn, int verbose);

int program_verify_SPI(EdtDev *edt_p, EdtBitfile *bitfile, EdtPromData *pdata, int promcode,
